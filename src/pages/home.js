...
export default function Home() {
  return (
    <>
      ...
      <div className="relative group w-3/4 md:w-1/3 h-64 xl:h-79 2xl:h-80 3xl:h-90 mx-auto md:mx-5 m-5 ">
        <img
          src={widget1}
          alt="Descriptive Alt Text"
          className="w-full h-full object-cover"
        />
        <div className="absolute bottom-0 w-full bg-white text-black p-4 transition-all duration-300 ease-in-out transform">
          <h3 className="font-bold montserrat">Unforgettable Moments</h3>
          <p className="max-h-0 overflow-hidden transition-max-height duration-300 ease-in-out group-hover:max-h-60">
      ...
      <div className="relative group w-3/4 md:w-1/3 h-64 xl:h-79 2xl:h-80 3xl:h-90 mx-auto md:mx-5 m-5">
        ...
        />
        <div className="absolute bottom-0 w-full bg-white text-black p-4 transition-all duration-300 ease-in-out transform">
          <h3 className="font-bold montserrat">Love in Every Shot</h3>
          <p className="max-h-0 overflow-hidden transition-max-height duration-300 ease-in-out group-hover:max-h-60">
      ...
      <div className="relative group w-3/4 md:w-1/3 h-64 xl:h-79 2xl:h-80 3xl:h-90 mx-auto md:mx-5 m-5">
        ...
        />
        <div className="absolute bottom-0 w-full bg-white text-black p-4 transition-all duration-300 ease-in-out transform">
          <h3 className="font-bold montserrat">Your Day, Your Story</h3>
          <p className="max-h-0 overflow-hidden transition-max-height duration-300 ease-in-out group-hover:max-h-60">
